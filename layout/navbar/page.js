...
const Navbar = () => {
  ...
  return (
    <nav className="p-4">
      <ul className="navbar-item flex lg:space-x-5 text-[#0e2b49] font-light">
        <li>
          <Link
            href="/pages/home"
  ...
  {isCompanyDropdownOpen && (
    <div className="absolute left-0 bg-[#e47316] text-white shadow-md rounded-lg mt-2 w-72 z-50" ref={dropdownRef}>
      <ul className="space-y-2 py-2 h-96 overflow-y-scroll scrollbar-hide">
        ...
        <li><Link href="/pages/companies/dropdown-menu/chittagong-chicks-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/chittagong-chicks-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Chittagong Chicks Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/chittagong-feed-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/chittagong-feed-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Chittagong Feed Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/denm-poultry-complex-pvt-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/denm-poultry-complex-pvt-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Denm Poultry Complex Pvt Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/jessore-feed-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/jessore-feed-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Jessore Feed Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/moynamoti-hatchery-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/moynamoti-hatchery-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Moynamoti Hatchery Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/paragon-agro-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/paragon-agro-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Paragon Agro Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/parasol-energy-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/parasol-energy-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Parasol Energy Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/paragon-feed-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/paragon-feed-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Paragon Feed Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/paragon-plastic-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/paragon-plastic-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Paragon Plastic Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/paragon-plast-fiber-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/paragon-plast-fiber-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Paragon Plast Fiber Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/paragon-poultry-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/paragon-poultry-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Paragon Poultry Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/paragon-press-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/paragon-press-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Paragon Press Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/parasole-footware-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/parasole-footware-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Parasole Footware Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/rangpur-poultry-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/rangpur-poultry-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Rangpur Poultry Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/shalbahan-farms-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/shalbahan-farms-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Shalbahan Farms Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/sympa-solar-power-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/sympa-solar-power-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Sympa Solar Power Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/usha-poultry-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/usha-poultry-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Usha Poultry Ltd</Link></li>
        <li><Link href="/pages/companies/dropdown-menu/fatehbagh-tea-company-ltd" className={`block px-4 py-2 ${isActive('/pages/companies/dropdown-menu/fatehbagh-tea-company-ltd') ? 'text-[#f3a019]' : 'hover:text-white'} border-b border-white`} onClick={closeDropdown}>Fatehbagh Tea Company Ltd</Link></li>
      </ul>
    </div>
  )}
</li>
        ...
        <li className="relative">
          <button
            ...
            className={`flex items-center space-x-1 ${isActive("/pages/media") ? dropdown-menu/"text-[#f3a019]" : "hover:text-[#f3a019]"}`}
          >
            <span>Media</span>
            <ChevronDown size={16} />
          </button>
